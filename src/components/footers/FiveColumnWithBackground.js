    ...
    <Container>
      <Content>
        <FiveColumns>
          ...
          <Column>
            <ColumnHeading>Volunteers</ColumnHeading>
            <LinkList>
              <LinkListItem>
                <Link href="/volunteer/signup">Sign Up</Link>
              </LinkListItem>
              <LinkListItem>
          ...
          <Column>
            <ColumnHeading>NGOs</ColumnHeading>
            <LinkList>
              <LinkListItem>
              ...
              <LinkListItem>
                <Link href="/ngo/activity/create">Create Activity</Link>
              </LinkListItem>
              <LinkListItem>
        ...
        <ThreeColRow>
          <LogoContainer>
            ...
            <LogoText>NGO Connect</LogoText>
          </LogoContainer>
          <CopywrightNotice>&copy; 2024 NGO Connect. All Rights Reserved.</CopywrightNotice>
